    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <button type="button" class="btn btn-success" data-toggle="modal" data-target="#createNewPatientModal">
  New Patient
</button>
<br>
<br>
...
<section class="page-section" id="patient_admission">
      ...
      <form class="form-horizontal" action="php_action\create_patient.php" method="POST" id="createRecordForm">
...
<div class="modal fade" tabindex="-1" role="dialog" id="editRecordModal" >
   ...
   <form class="form-horizontal" action="php_action/update_patients.php" method="POST" id="updateRecordForm">
