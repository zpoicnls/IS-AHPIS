...
<!-- Page Heading -->
<h1 class="h3 mb-2 text-gray-800">User Account Details</h1>
...
<div class="modal fade" tabindex="-1" role="dialog" id="createuserModal" >
   ...
   <form class="form-horizontal" action="../../includes/createUsersAccount.inc.php" method="POST" id="updateRecordForm">       
        <div class="modal-body">
           <div class="form-group">
                             <label for="usersLName">Last Name:</label>
                          
                             <input type="text" name="usersLName" id="usersLName"  class="form-control" onKeyPress="if(this.value.length==30) return false;" min="0" required autofocus>
                             ...
                             <input type="text" name="usersFName" id="usersFName"  class="form-control" onKeyPress="if(this.value.length==30) return false;" min="0" required autofocus>
                             ...
                             <input type="text" name="usersMName" id="usersMName"  class="form-control" onKeyPress="if(this.value.length==30) return false;" min="0" required autofocus>
                             ...
                             <input type="text" name="usersEmail" id="usersEmail"  class="form-control" onKeyPress="if(this.value.length==30) return false;" min="0" required autofocus>
                             ...
                             <input type="text" name="usersUid" id="usersUid"  class="form-control" onKeyPress="if(this.value.length==30) return false;" min="0" required autofocus>
                    ...
                    <div class="form-group">
                             ...
                             <br>
                    <select class="form-select" name="usersType" aria-label="Default select example">
...
<!-- edit modal -->
  <div class="modal fade" tabindex="-1" role="dialog" id="editUserAccountModal" >
   ...
   <form class="form-horizontal" action="php_action/update_user.php" method="POST" id="updateRecordForm">
        ...
        <div class="modal-body">
           ...
           <div class="form-group">
                             ...
                             <input type="text" name="update_email" id="update_email"  class="form-control" onKeyPress="if(this.value.length==30) return false;" min="0" required autofocus>
                             ...
                             <input type="text" name="update_uname" id="update_uname"  class="form-control" onKeyPress="if(this.value.length==30) return false;" min="0" required autofocus>
                             ...
                             <input type="text" name="update_pword" id="update_pword"  class="form-control" onKeyPress="if(this.value.length==30) return false;" min="0" required autofocus>
